...
def main():
    ...
    st.title('Infotech Academy Group B Airbnb Model App')

      #Setting Application description
    st.markdown("""
     :dart:  The aim of this project is to predict the prices of Airbnb listings. \n 
     The machine learning model takes into account factors such as property features, location,
     and date range to provide users with reference prices. \n
    """)
